            ...
            <div className="container px-6 py-10 mx-auto">
                <div className="lg:flex lg:items-center">
                    <div className="w-full space-y-12 lg:w-1/2 ">
                        <div>
                            <h1 className="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white">Here<br></br>is our Basic Guides to Help You</h1>
                        ...
                        <div className="md:flex md:items-start md:-mx-4">
                            ...
                            <div className="mt-4 md:mx-4 md:mt-0">
                                <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Account Creation</h1>

                                <p className="mt-3 text-gray-500 dark:text-gray-300">
                                Begin the registration process by creating an account, filling the necessary information like name, email, and username.
                                After registration, the applicant is directed to create a profile on the website. This involves writing a brief summary of skills, uploading a profile picture, including work experience, and adding any necessary certifications or licenses.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="md:flex md:items-start md:-mx-4">
                            ...
                            <div className="mt-4 md:mx-4 md:mt-0">
                                <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Engage to our Clients</h1>

                                <p className="mt-3 text-gray-500 dark:text-gray-300">
                                    Once the profile is complete, the applicant can browse job listings and explore available freelance opportunities that match their skills and interests.
                                    When a job that matches their skill is found, the applicant can submit proposals or bid for the project.
                                    If the client finds the applicant's proposal suitable, the client schedules an interview either by chat or phone call. During this process, the client outlines project objectives and requirements in detail and discusses expected timelines.
                               </p>
                            </div>
                        </div>
                        ...
                        <div className="md:flex md:items-start md:-mx-4">
                            ...
                            <div className="mt-4 md:mx-4 md:mt-0">
                                <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Project Implementation and Get Paid</h1>

                                <p className="mt-3 text-gray-500 dark:text-gray-300">
                                After a successful interview, the client hires the applicant to start work on the project. During implementation, the freelancer works closely with the client, keeping them updated with progress reports and delivering completed work within the stipulated time frame.
                                Once the project is completed, the client makes payment for the services rendered by the freelancer, and the account balance is updated.
                                A satisfied client who finds the freelancer's work impressive can re-engage their services or provide feedback that can encourage other potential clients to hire them.  This feedback helps freelancers to further establish their reputation on the platform, which can lead to more job opportunities.
                                </p>
                            </div>
                        </div>
                    </div>
