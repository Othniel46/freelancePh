  ...
  return (
    <div className="">
      <Popover className="relative inline-block text-left">
        ...
        >
          <Popover.Panel className="absolute right-0 mt-6  p-2 origin-top-right divide-y divide-gray-100 rounded-xl bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
            <div className="w-fit">
              {user ? (
                <div className="flex flex-col bg-white px-10 pt-4 rounded-xl">
                  <div>
                    <div
                      className="
                     text-gray-900
